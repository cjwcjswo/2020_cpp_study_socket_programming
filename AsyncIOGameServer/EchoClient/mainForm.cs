...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        private void echoButton_Click(object sender, EventArgs e)
        {
            ...
            byte[] textBytes = Encoding.UTF8.GetBytes(textSendText.Text);
            Int16 dummyId = 1;
            Int16 size  = (Int16)(textBytes.Length + 4);
            dataSource.AddRange(size.GetBytes());
            dataSource.AddRange(dummyId.GetBytes());
            dataSource.AddRange(textBytes);
